    ...
    .when({
        ...
        $any: function(state, event) {
            if (event.eventType === "PATIENT_CREATED_v1") {
                ...
                state.objects[propertyStreamId] = {
                    type: 'property',
                    id: propertyStreamId,
                    name: event.data.name
                }
                ...
                state.objects[propertyValueStreamId] = {
                    type: 'property-value',
                ...
                // Find the activity, enhance with data.name or data.notes if avail
                var activity = event.data.notes || event.data.value || event.eventType
