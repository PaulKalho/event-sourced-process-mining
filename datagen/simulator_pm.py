...
def setup_grpc_client(server_address: str) -> None:
    ...
    channel = grpc.intercept_channel(
        grpc.insecure_channel(server_address), interceptor)
...
def simulate_complication_process(patient_id: uuid.UUID) -> bool:
    ...
    reanimation_task = create_task("", "Reanimation", patient_id)
    update_task(reanimation_task, pb.TaskStatus.TASK_STATUS_DONE)
